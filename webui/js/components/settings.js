...
class SettingsComponent {
    ...
    showPasswordVerification() {
        const content = `
            <div class="password-auth-container max-w-md mx-auto mt-20 p-8 bg-white rounded-lg shadow-lg">
                <div class="auth-header text-center">
                    <i class="fas fa-lock text-4xl text-blue-500 mb-4"></i>
                    <h2 class="text-2xl font-bold text-gray-800 mb-2">设置页面访问验证</h2>
                    <p class="text-gray-600 mb-6">为保护Cookie等敏感信息，请输入访问密码</p>
                </div>
                
                <div class="auth-form">
                    <div class="mb-4">
                        <label for="access-password" class="block text-sm font-medium text-gray-700 mb-2">
                            <i class="fas fa-key mr-2"></i>访问密码
                        </label>
                        <input type="password" 
                               id="access-password" 
                               placeholder="请输入访问密码" 
                    ...
                    <div class="flex flex-col gap-3">
                        <button id="verify-password-btn" 
                            ...
                            <i class="fas fa-unlock mr-2"></i>验证密码
                        </button>
                        ...
                        <button id="forgot-password-btn" 
                            ...
                            <i class="fas fa-question-circle mr-2"></i>忘记密码？
                        </button>
                    </div>
                </div>
        ...
        const content = `
            <div class="password-auth-container max-w-md mx-auto mt-20 p-8 bg-white rounded-lg shadow-lg">
                <div class="auth-header text-center">
                    ...
                    <h2 class="text-2xl font-bold text-gray-800 mb-2">设置访问密码</h2>
                    <p class="text-gray-600 mb-6">首次使用，请设置访问密码以保护Cookie等敏感信息</p>
                </div>
                ...
                <div class="auth-form">
                    ...
                    <div class="mb-6">
                        <label for="confirm-password" class="block text-sm font-medium text-gray-700 mb-2">
                            <i class="fas fa-key mr-2"></i>确认密码
                        </label>
                        <input type="password" 
                               id="confirm-password" 
                               placeholder="请再次输入密码" 
                    ...
                    <button id="setup-password-btn" 
                        ...
                        <i class="fas fa-lock mr-2"></i>设置密码
                    </button>
                </div>
                
                <div id="setup-message" class="mt-4 text-center"></div>
            </div>
        `;
